...
var BorderNode = function (_Node) {
    ...
    function BorderNode(location, json, model) {
        ...
        _this._attributes["splitterSize"] = typeof json.splitterSize !== "undefined" ? json.splitterSize : _this._model.getSplitterSize();
        _this._attributes["custom"] = typeof json.custom !== "undefined" ? json.custom : null;
    ...
    _createClass(BorderNode, [{
        ...
        value: function _layout(borderRects) {
            ...
            var split3 = location.split(split2.end, this._adjustedSize + this.getSplitterSize()); // split off tab contents
            var split4 = location.reflect().split(split3.start, this.getSplitterSize()); // split contents into content and splitter
