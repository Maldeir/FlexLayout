    ...
    _createClass(Tab, [{
        ...
        value: function render() {
            ...
            if (node && node._parent && node._parent._attributes && node._parent._attributes.splitterSize) {
                flag = true;
                var splitterSize = node._parent._attributes.splitterSize;
                var divHeight = parseFloat(style.height.split('px')[0]) - 2 * splitterSize;
            ...
            child = flag ? _react2.default.createElement(
                "div",
                { className: "flexlayout__internal__border__boder", style: externalborders },
                child
            ) : child;
